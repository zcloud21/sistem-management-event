<div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <tr>
            <td style="padding: 20px 0;">
                <div style="display: flex; flex-direction: column; align-items: center;">
                    <img src="data:image/svg+xml;base64," alt="Logo Placeholder" style="width: 60px; height: 60px; margin-bottom: 10px;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
        <tr>
            ...
            <td style="width: 50%; vertical-align: top;">
                <h3 style="border-bottom: 1px solid #333; padding-bottom: 5px; margin-bottom: 10px;">Bill To</h3>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
        ...
        <tbody>
            <tr>
                <td style="border-bottom: 1px solid #ddd; padding: 10px;">Biaya Pendaftaran Event: {{ $invoice->event->event_name ?? 'Event' }}</td>
