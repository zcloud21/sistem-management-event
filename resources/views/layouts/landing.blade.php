...
<body class="font-sans antialiased bg-white">
    ...
    <nav class="bg-white shadow-md py-4 px-6 flex justify-between items-center sticky top-0 z-50">
        <div class="flex items-center">
            <a href="/" class="text-xl font-bold text-primary">EventScape</a>
        </div>
        ...
        <div class="flex items-center space-x-4">
            @if (Route::has('login'))
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 font-medium hover:text-primary transition">Log in</a>
    ...
    <footer class="bg-gray-50 py-12 mt-16">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-xl font-bold text-primary mb-4">EventScape</h3>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li>Email: info@eventscape.com</li>
                        <li>Telepon: (021) 12345678</li>
                        <li>Alamat: Jl. Event No. 123, Jakarta</li>
                    </ul>
                </div>
            </div>
            
            <div class="mt-8 pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
                &copy; {{ date('Y') }} EventScape. All rights reserved.
            </div>
        </div>
    </footer>
</body>
