        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <form action="{{ route('venues.update', $venue->id) }}" method="POST">
            ...
            <div class="mb-4">
              ...
              <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $venue->name)" required autofocus />
            </div>
            ...
            <div class="mb-4">
              ...
              <x-text-input id="capacity" class="block mt-1 w-full" type="number" name="capacity" :value="old('capacity', $venue->capacity)" required />
            </div>

            <div class="mb-4">
              <x-input-label for="price" :value="__('Harga Sewa (Rp)')" />
              <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price', $venue->price)" required />
            </div>
